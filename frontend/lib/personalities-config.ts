...
export const CARTESIA_VOICES_ES = [
  ...
  { id: '5c5ad5e7-1020-476b-8b91-fdcbe9cc313c', name: 'Daniela - Mujer Relajada (MX)' },
  { id: '399002e9-7f7d-42d4-a6a8-9b91bd809b9d', name: 'Diego - Entusiasta' },
  { id: 'cefcb124-080b-4655-b31f-932f3ee743de', name: 'Elena - Narradora (ES)' },
  ...
  { id: '5ef98b2a-68d2-4a35-ac52-632a2d288ea6', name: 'Gabriel - Hombre Serio (ES)' },
  { id: 'dbaa1a0d-e004-442d-866f-5431b18d8d54', name: 'Guadalupe - Cuentacuentos' },
  { id: 'b042270c-d46f-4d4f-8fb0-7dd7c5fe5615', name: 'Héctor - Guía Turístico (ES)' },
  { id: 'c0c374aa-09be-42d9-9828-4d2d7df86962', name: 'Isabel - Maestra (ES)' },
  ...
  { id: 'b5aa8098-49ef-475d-89b0-c9262ecf33fd', name: 'Luis - Noticiero (ES)' },
  ...
  { id: '846fa30b-6e1a-49b9-b7df-6be47092a09a', name: 'Pablo - Narrador Castizo (ES)' },
  ...
  { id: '15d0c2e2-8d29-44c3-be23-d585d5f154a1', name: 'Pedro - Hablante Formal (MX)' },

...
export const CARTESIA_VOICES_ES = [
  ...
  { id: '5c5ad5e7-1020-476b-8b91-fdcbe9cc313c', name: 'Daniela - Mujer Relajada (MX)', gender: 'F' },
  ...
  { id: '846fa30b-6e1a-49b9-b7df-6be47092a09a', name: 'Pablo - Narrador Castizo (ES)', gender: 'M' },
...
const FEMALE_NAMES = new Set([
  ...
  'victoria', 'eleanor', 'joan', 'helen', 'anne', 'mary', 'emily', 'charlotte', 'virginia',
  'simone', 'rosa', 'amelia', 'ada', 'hypatia', 'hildegard', 'harriet', 'sojourner',
  'malala', 'indira', 'golda', 'angela', 'aung', 'benazir', 'eva', 'rigoberta',
  'sor', 'santa', 'madre', 'reina', 'princesa', 'emperatriz', 'condesa', 'duquesa',
  'sacerdotisa', 'profetisa', 'diosa',
]);
...
const MALE_NAMES = new Set([
  ...
  'sun', 'genghis', 'julius', 'augustus', 'marco', 'martin', 'nelson', 'winston', 'buda', 'buddha',
...
export function detectGender(name: string): 'F' | 'M' | null {
  ...
  const femaleTitles = ['sra', 'sra.', 'señora', 'doña', 'dra', 'dra.', 'doctora', 'reina', 'princesa', 'emperatriz', 'sor', 'santa', 'madre', 'hermana'];
  const maleTitles = ['sr', 'sr.', 'señor', 'don', 'dr', 'dr.', 'doctor', 'rey', 'príncipe', 'principe', 'emperador', 'san', 'santo', 'padre', 'fray', 'hermano'];
